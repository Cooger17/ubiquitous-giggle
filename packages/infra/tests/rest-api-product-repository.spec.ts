...
describe('ProductRepository', () => {
    ...
    test('getProductById - failure', async () => {
        ...
        await expect(repository.getProductById(1)).rejects.toThrow('Failed to get product: Not Found');
    });
    ...
    test('createProduct - success', async () => {
        ...
        await expect(repository.createProduct({
            ...
            createdAt: new Date(),
            updatedAt: new Date()
        } as Product)).resolves.toBeUndefined();
    });
    ...
    test('createProduct - failure', async () => {
        ...
        await expect(repository.createProduct({
            ...
            createdAt: new Date(),
            updatedAt: new Date()
         } as Product)).rejects.toThrow('Failed to create product: Bad Request');
    });
    ...
    test('updateProduct - failure', async () => {
        ...
        await expect(repository.updateProduct({ 
            ...
            createdAt: new Date(),
            updatedAt: new Date()
         } as Product)).rejects.toThrow('Failed to update product: Bad Request');
    });
    ...
    test('deleteProduct - success', async () => {
        ...
        const product = await repository.deleteProduct(1);
        expect(product).toEqual(mockProduct);
    });
    ...
    test('deleteProduct - failure', async () => {
        ...
        await expect(repository.deleteProduct(1)).rejects.toThrow('Failed to delete product: Not Found');
    });
    ...
    test('getProductsByCategory - success', async () => {
        ...
        const products = await repository.getProductsByCategory(1);
    ...
    test('getProductsByCategory - failure', async () => {
        ...
        await expect(repository.getProductsByCategory(1)).rejects.toThrow('Failed to get products: Internal Server Error');
    });
    ...
    test('listProducts - failure', async () => {
        ...
        await expect((await repository).listProducts(1, 10)).rejects.toThrow('Failed to get products: Internal Server Error');
    });
});
 */
